...
export default function AttorneyHomeSection() {
  ...
  return (
    <main className="flex-1 px-10 py-8 bg-[#F7F6F3] transition-all duration-300 ease-in-out">
      ...
      {isVerified && (
        <section>
          <h2 className="text-lg font-bold text-[#16305B] mb-4">Quick Actions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="bg-white rounded shadow p-6 hover:shadow-lg transition-shadow text-left">
              <div className="text-[#16305B] font-semibold mb-2">📁 View All Cases</div>
              <p className="text-sm text-gray-600">Access and manage all your active cases</p>
            </button>
            <button className="bg-white rounded shadow p-6 hover:shadow-lg transition-shadow text-left">
              <div className="text-[#16305B] font-semibold mb-2">📅 Check Schedule</div>
              <p className="text-sm text-gray-600">View your upcoming trials and events</p>
            </button>
            <button className="bg-white rounded shadow p-6 hover:shadow-lg transition-shadow text-left">
              <div className="text-[#16305B] font-semibold mb-2">⚙️ Account Settings</div>
