...
export default function JurorSidebar() {
  ...
  const navLinks = [
    { id: "profile", label: "Profile", icon: <User className="w-6 h-6" />, href: "/juror/profile" },
    { id: "notifications", label: "Notifications", icon: <Bell className="w-6 h-6" />, href: "/juror/notifications" },
  ];

  const mainNav = [
    { id: "home", label: "Home", icon: <Home className="w-6 h-6" />, href: "/juror", active: true },
    { id: "assigned", label: "Assigned Cases", icon: <Briefcase className="w-6 h-6" />, href: "/juror/assigned" },
    { id: "jobs", label: "Job Board", icon: <Briefcase className="w-6 h-6" />, href: "/juror/jobs" },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Section Label (optional, same structure as attorney) */}
      <div
