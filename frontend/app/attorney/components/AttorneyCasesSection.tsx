            ...
            {paginatedCases.map((c) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-[#16305B] cursor-pointer overflow-hidden group"
                >
                  {/* Card Header */}
                  <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-[#16305B] to-[#1e417a]">
