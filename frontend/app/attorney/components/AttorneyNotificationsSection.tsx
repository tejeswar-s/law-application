        ...
        <div className="flex items-center gap-3">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="px-4 py-2 bg-white text-[#16305B] rounded text-sm font-medium hover:bg-gray-50 transition"
            >
              Mark All Read
            </button>
          )}
      ...
      <div className="bg-white rounded shadow">
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#16305B]"></div>
          </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-[#16305B]">
                        {notification.Title}
                      </h3>
                      {!notification.IsRead && (
