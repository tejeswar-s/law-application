...
export default function DefendantDetails() {
  ...
  // Handle Next button (add navigation to next step if needed)
  const handleNext = (e: React.FormEvent) => {
    e.preventDefault();
    router.push("/cases/new/voir-dire-1");
  };
      ...
      <main className="flex-1 px-10 py-8">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div className="flex items-center gap-2">
            <span className="w-5 h-5 rounded-full border-2 border-[#16305B] flex items-center justify-center bg-white text-[#16305B] font-bold">3</span>
            <span className="font-semibold text-[#16305B]">Defendant Details</span>
          </div>
          <span className="h-1 w-8 bg-[#e0e6f1] rounded"></span>
        ...
        <h1 className="text-2xl font-bold text-[#16305B] mb-2">Defendant Details</h1>
        <p className="mb-8 text-[#6B7280] text-base">Fill in Defendant details for this case.</p>

        <form className="max-w-2xl" onSubmit={handleNext}>
          <div className="bg-white rounded shadow p-8 mb-6">
            <h2 className="text-lg font-bold text-[#16305B] mb-4">Defendant Group #1</h2>
            ...
            <div className="mb-4">
              <label className="block font-medium text-[#16305B] mb-1">
                Defendant Name #1 <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                name="defendantName"
                ...
                onChange={handleChange}
                className="w-full border border-[#bfc6d1] rounded px-4 py-2 bg-white text-[#16305B] focus:outline-[#16305B]"
                placeholder="Defendant Name #1 (First Name, Middle Name, Last Name)"
                required
              />
            </div>
            <button
              ...
              // onClick={...}
            >
              <PlusCircle size={18} /> Add Defendant
            </button>
          </div>
          <button
            type="button"
            ...
            // onClick={...}
          >
            <PlusCircle size={18} /> Add Another Defendant Group
          </button>
          <button
            type="submit"
